...
function DashboardPageContent() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: layoutMode === 'chat-only' ? 'rgb(255, 255, 255)' : 'rgb(250, 252, 254)' }}>
      {/* 顶部标题栏 - 移动端简化版 */}
      {isMobile ? (
        ...
        {isMobile ? (
          ...
          <>
            ...
            {layoutMode === 'chat-only' ? (
              ...
              <>
                {/* 左侧对话框 */}
                <div className={`${getChatWidth()} ${getChatPosition()} panel-transition border-r border-slate-300 bg-white flex-shrink-0 ${layoutMode === 'workspace-only' ? 'border-r-0' : ''}`}>
